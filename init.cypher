...
CREATE (ncantu:User {lastName:'Cantu', firstName:'Nicolas', email:'nicolas.cantu@instriit.com', id:userUid})
CREATE (user1:User {lastName:'Cantu', firstName:'Nicolas', email:'nicolas.cantu@instriit.com', id:userUid})
CREATE (admin:UserGroup {lastName:'Service', firstName:'Admin', email:'admin@instriit.com', id:userGroupUid})
CREATE (user:UserGroup {lastName:'Service', firstName:'User', email:'user@instriit.com', id:userGroupUid})
CREATE (device1:Device, id:deviceUid)
CREATE (media1:Media, id:mediaUid)
CREATE (domain1:Domain {dns:'instriit.com', id:domainUid})
CREATE (campaign1:Campaign, id:campaignUid)
CREATE (resource1:Resource {urlPath:'img', urlName:'resource1', urlExt:'.png', crc:'564654sdf4', id:resourceUid})
CREATE (resource2:Resource  {urlPath:'img', urlName:'resource2', urlExt:'.png', crc:'564654dqsdqsdsdf4', id:resourceUid})
CREATE (format1:Format {listId:['hq'], contentType: 'image/png', height: 480, heightUnit: 'px', width: 38, widthUnit: 'px', weight: 19, weightUnit: 'ko', id:foramtUid})
CREATE (analyticScriptCall1:AnalyticScriptCall {title: 'analyticScriptCall1', google: '<script></scrypt>', crm: '<script></scrypt>', salesforce: '<script></scrypt>', other: '<script></scrypt>', id:analyticScriptCallUid})
CREATE (analyticUrlCall1:AnalyticUrlCall {google: 'http://', crm: 'http://', salesforce: 'http://', other: 'http://', id:analyticUrlCalUid})
CREATE (segment1:Segment {id:segmentUid})
CREATE (adminRight:Right {id:rightUid})
CREATE (userRight:Right {id:rightUid})
CREATE (create:Action {id:actionUid})
CREATE (publish:Action {id:actionUid})
CREATE (test:Action {id:actionUid})
CREATE (valid:Action {id:actionUid})
CREATE (host:Action {id:actionUid})
CREATE (use:Action {id:actionUid})
CREATE (state:Action {id:actionUid})
CREATE (manage:Action {id:actionUid})
CREATE (target:Action {id:actionUid})
CREATE (represente:Action {id:actionUid})
CREATE (collect:Action {id:actionUid})
CREATE (authorise: {id:actionUid}Action)
CREATE (optimize:Action {id:actionUid})
CREATE (init:Action {id:actionUid})
CREATE (own:Action {id:actionUid})
CREATE (identify:Action {id:actionUid})
CREATE (mark:Action {id:actionUid})
CREATE (expire:Action {id:actionUid})
CREATE (localize:Action {id:actionUid})
CREATE (show:Action {id:actionUid})
CREATE (size:Action {id:actionUid})
CREATE (historize:Action {id:actionUid})
CREATE (contributeTo:Action {id:actionUid})
CREATE (concern:Action {id:actionUid})
CREATE (cost:Action {id:actionUid})
CREATE (stock:Action {id:actionUid})
CREATE (shipp:Action {id:actionUid})
CREATE (order:Action {id:actionUid})
CREATE (pay:Action {id:actionUid})
CREATE (billing:Action {id:actionUid})
CREATE (expedite:Action {id:actionUid})
CREATE (payBack:Action {id:actionUid})
CREATE (shippManange:Action {id:actionUid})
CREATE (expediteManange:Action {id:actionUid})
CREATE (payManange:Action {id:actionUid})
CREATE (produce:Action {id:actionUid})
CREATE (ask:Action {id:actionUid})
CREATE (balance:Action {id:actionUid})
CREATE (note:Action {id:actionUid})
CREATE (comment:Action {id:actionUid})
CREATE (todo:Step {id:stepUid})
CREATE (created:Step {id:stepUid})
CREATE (published:Step {id:stepUid})
CREATE (tested:Step {id:stepUid})
CREATE (validated:Step {id:stepUid})
CREATE (accessed:Step {id:stepUid})
CREATE (used:Step {id:stepUid})
CREATE (updated:Step {id:stepUid})
CREATE (expireded:Step {id:stepUid})
CREATE (integrityFalse:Step {id:stepUid})
CREATE (quality1:Quality {id:qualityUid})
CREATE (contract1:Contract {id:contactUid})
CREATE (DianeKruger:Owner {fullName: 'Diane Kruger', firstName: 'Diane', lasteName: 'Kruger', compagny: 'Diane Kruger', id:ownerUid})
CREATE (Instriit:Owner {fullName: 'Diane Kruger', firstName: 'Diane', lasteName: 'Kruger', compagny: 'Diane Kruger', id:ownerUid})
CREATE (token1:Token {id:tokenUid})
CREATE (b2c:Tag {id:tagUid})
CREATE (expireControler1:ExpireControler {id:expireControlerUid})
CREATE (fr:Localization {code: 'fr', locale: 'Europe/Paris', lang: 'fr-FR', charset:'utf-8', moneyUnit:'euro', id:localizationUid})
CREATE (place1:Place {id:placeUid})
CREATE (history1:History {id:historyUid})
CREATE (membership1:Membership {id:membershipUid})
CREATE (productCategorie1:ProductCategory {id:categoryUid})
CREATE (product1:Product {id:productUid})
CREATE (price1:Price {value:20, id:priceUid})
CREATE (stock1:Stock {value:20, unit:'unit', id:stockUid})
CREATE (shipping1:Shipping {value:20, unit:'unit', id:shippingUid})
CREATE (order1:Order {id:orderUid})
CREATE (bankTransaction1:BankTransaction {id:bankTransactionUid})
CREATE (bill1:Bill {id:billUid})
CREATE (expedition1:Expedition {id:expeditionUid})
CREATE (expeditionReturn1:ExpeditionReturn {open:false, motif:'', id:expeditionReturnUid})
CREATE (payBack1:PayBack {id:payBackUid})
CREATE (clientRequest1:ClientRequest {id:clientRequestUid})
CREATE (shipper1:Shipper {id:shipperUid})
CREATE (expeditor1:Expeditor {id:expeditorUid})
CREATE (bank1:Bank {id:bankid})
CREATE (bankFacility1:BankFacility {id:facilityUid})
CREATE (clientManager1:ClientManager {id:clientManagerUid})
CREATE (productor1:Productor {id:productorUid})
CREATE (client1:Client {id:clientUid})
CREATE (hostPublic1:Host {ip:'', nameInt:'', nameExt:'', hosting:'gandi', sslCompatibilty: true, id:hostUid})
CREATE (hostFront1:Host {ip:'', nameInt:'', nameExt:'', hosting:'gandi', sslCompatibilty: true, id:hostUid})
CREATE (integrityControler1:IntegrityControler {id:integrityControlerUid})
