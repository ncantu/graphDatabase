...
CREATE (app:Application {name: '{app_name}', json:'{app_json}'}),
CREATE (hApp:HostApp {SERVER_PATH: '{hApp_SERVER_PATH}', SERVER_SYSTEMROOT: '{hApp_SERVER_SYSTEMROOT}', SERVER_COMSPEC: '{hApp_SERVER_COMSPEC}', 
...
CREATE (u:User {securityLevel: '{u_securityLevel}', idCryptedT: '{u_idCryptedT}', idCryptedS: '{u_idCryptedS}', id: '{u_id}'),
(uh:UserHistory),
...
(mock:Mock {userId: '{mock_userId}', appName: '{mock_appName}', mockName: '{mock_mockName}', mockJson: '{mock_json}'}),
(u)-[:CALL]->(req),
